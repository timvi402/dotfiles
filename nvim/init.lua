...
-- Indentation settings: use 4 spaces instead of tabs
...
require("lazy").setup({
	...
	{ -- Highlight, edit, and navigate code
		...
		-- [[ Configure  ]] See `:help nvim-treesitter`
		opts = {
			ensure_installed = {
				"bash",
				"c",
		...
		-- There are additional nvim- modules that you can use to interact
		-- with nvim-. You should go explore a few and see what interests you:
		--
		--    - Incremental selection: Included, see `:help nvim--incremental-selection-mod`
		--    - Show your current context: https://github.com/nvim-/nvim-treesitter-context
